    ...
    <h1 class="heading">Dashboard</h1>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                ?>
                <h3><span>$<?= $total_pendings; ?></span><span>/-</span></h3>
                <p>TOTAL</p>
            ...
            <div class="box">
                ...
                ?>
                <h3><span>$<?= $total_completes; ?></span><span>/-</span></h3>
                <p>TOTAL</p>
                <a href="placed_orders.php" class="btn">Voir Les Commandes</a>
            </div>
            ...
            <div class="box">
                <?php
                $select_orders = $conn->prepare("SELECT * FROM `fournisseur`");
                $select_orders->execute();
                $numbers_of_orders = $select_orders->rowCount();
                ?>
                <h3><?= $numbers_of_orders;  ?></h3>
                <p>Total Des Fournisseurs</p>
                <a href="fournisseurs/liste.php" class="btn">Valider les Fournisseur</a>
            </div>
            ...
            <div class="box">
                ...
                <p>Comptes Des Utilisateurs</p>
                <a href="users_accounts.php" class="btn">Voir Utilisateur</a>
            </div>
            ...
            <div class="box">
                ...
                <p>Total Admin</p>
                <a href="admins_accounts.php" class="btn">Voir Utilisateur</a>
            </div>
