...
if(isset($_POST['submit'])){
 ...
 if ($old_pass == $empty_pass){
    $message[] = 'entrer ancien mot de passe';
 }elseif($old_pass != $prev_pass){
    $message[] = 'ancien mot de passe non confirmé';
    ...
    $update_pass -> execute([$confirm_pass, $user_id]);
        ...
        $message[] ="entrere un nouveau mot de passse";
    }
 }
}
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" name="old_pass" type="password" placeholder="ancien mot de passe" oninput="this.value = 
                                    this.value.replace(/\s/g, '')">
                                </div>
                                <div class="col-md-6">
                                    <input class="form-control" name="new_pass" type="password" placeholder="nouveau mot de passe" oninput="this.value = 
                                    this.value.replace(/\s/g, '')">
                                </div>
                                <div class="col-md-6">
                                    <input class="form-control" name="confirm_pass" type="password" placeholder="nouveau mot de passe" oninput="this.value = 
                                    this.value.replace(/\s/g, '')">
                                </div>
                                <div class="col-md-12">
